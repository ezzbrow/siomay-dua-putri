...
<head>
    ...
    <title>Daftar — Siomay Dua Putri</title>
    <style>
        :root {
            --bg-page: #FFF7ED;
            --bg-card: #FFFFFF;
...
<main>
    <div class="auth-card">
        ...
        <p class="lead">Buat akun untuk checkout pesanan dan melihat riwayat pesanan.</p>
        ...
        <form method="post" action="<?= base_url('daftar') ?>" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" value="<?= esc(old('nama')) ?>" required maxlength="255" autocomplete="name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="nomor_hp">Nomor HP <span style="font-weight:400;color:var(--ink-soft);">(opsional)</span></label>
                <input type="tel" id="nomor_hp" name="nomor_hp" value="<?= esc(old('nomor_hp')) ?>" maxlength="30" autocomplete="tel" placeholder="cth: 081234567890">
            </div>
